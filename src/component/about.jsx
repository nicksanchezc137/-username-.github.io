			...
			<div
				...
				<div className="row" style={{ marginTop: 7 + "rem" }}>
					<div className="col-12 col-lg-6 hidden">
						...
						Passionate Mobile Application Developer with 4 years of professional experience building mobile and web 
						applications that allow businesses to achieve their strategic objectives. 
						</p>
					</div>
					<div
						className={
